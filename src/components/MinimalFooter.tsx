      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-8">
          ...
          <motion.button
            ...
            className="group flex items-center gap-3 rounded-full bg-[#25D366] px-8 py-4 font-semibold text-white shadow-lg"
          ...
          <div className="text-center text-sm text-gray-500">
            ...
            <p className="mt-1">Premium Gaming & Tech Store</p>
          </div>
        </div>
      </div>
    </footer>
